...
class FEATURE {
  private:
    ...
    vector<CLASSES> TestClasses;                                                // List of pointers to class objects of observations ordered on value for testing
	...
	vector<OBSERVATION*> TestObservations;                                      // A vector of observations used for testing ordered by value
  ...
  public:
	...
	vector<CLASSES>* GetTestClasses();                                          // Return a pointer to the test Class
