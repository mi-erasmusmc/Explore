...
enum PARTITION_METHOD { RESUBSTITUTION, HOLDOUT, HOLDOUT_RANDOM_SUBSAMPLING, LEAVE_ONE_OUT, CROSS_VALIDATION };

// Function of this partition (for learning, for testing or both)
enum PARTITION_TYPE { LEARN, TEST, LEARNTEST, VALIDATION };
...
enum PERFORMANCE_MEASURE { SENSITIVITY, SPECIFICITY, PPV, NPV, ACCURACY };
